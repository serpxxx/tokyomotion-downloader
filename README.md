...
- :bulb: Request features: [Feature Requests](https://github.com/serpapps/tokyomotion-downloader/issues)
...
1. Open the latest release page:
   [https://github.com/serpapps/tokyomotion-downloader/releases/latest](https://github.com/serpapps/tokyomotion-downloader/releases/latest)
